	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			try {
				...
				/***************************2.開始修改資料*****************************************/
				CarDetailService cardetailSvc = new CarDetailService();
				cardetailVO = cardetailSvc.updateCarDetail(detail_no, order_no, vehicle_no, detail_date, detail_time, passenger_name, passenger_phone,getinto_address,arrival_address,sendcar_status);
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/cardetail/update_cardetail_input.jsp");
				failureView.forward(req, res);
			}
		}
...
//				Integer vehicle_no = new Integer(req.getParameter("vehicle_no").trim());
				...
				/***************************2.開始新增資料***************************************/
				CarDetailService cardetailSvc = new CarDetailService();
				cardetailVO = cardetailSvc.addCarDetail(order_no, vehicle_no, detail_date, detail_time, passenger_name, passenger_phone,getinto_address,arrival_address,sendcar_status);
